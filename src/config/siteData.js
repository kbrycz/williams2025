...
const siteData = {
  ...
  plan: {
    ...
    priorities: [
      { number: '1', title: 'Faith & Family Values', description: 'Protect the sanctity of life, defend religious liberty, and ensure parents \u2014 not the government \u2014 have the final say in how their children are raised and educated.' },
      { number: '2', title: 'Strong National Defense', description: 'Rebuild our military to be the strongest in the world. Support our veterans with the healthcare and benefits they earned, and stand firm against adversaries who threaten American interests.' },
      { number: '3', title: 'Free Market Economy', description: 'Get government out of the way so small businesses can thrive. Reduce regulations, lower the corporate tax burden, and create an environment where entrepreneurs and innovation flourish.' },
      { number: '4', title: 'Election Integrity', description: 'Require voter ID, clean up voter rolls, and ban ballot harvesting. Every legal vote must count, and every illegal vote must be stopped. Trust in elections is the foundation of our republic.' },
    ],
